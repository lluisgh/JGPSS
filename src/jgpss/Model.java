...
private void imprimirInfoFinal() {
    ...
    while (entries.hasNext()) {
        ...
        System.out.println(s.getNom() + ": " + s.getOcupants().size()
                + "transaccions amb un total de " + (s.getValor() - s.getLliures()) + "instˆncies capturades.");
    }
    ...
    //TODO dir qu hi ha en cada cua, storage i servidor. Bˆsicament crec que Žs rec—rrer el map i imprimir el nom i la qtt de transaccions que tŽ
}
